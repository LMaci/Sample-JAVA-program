	...
	public AboutWindow() {
		...
		try {
			lIcon = new JLabel(new ImageIcon(
				getClass().getResource("/zad1/resources/author_logo.jpg")));
		} 
		catch(Exception e) { 
			lIcon = new JLabel();
		}
		l0 = new JLabel("Projekt");
		l0.setFont(font1);
		l0.setHorizontalAlignment(SwingConstants.CENTER);
		l1 = new JLabel("wersja 2.0");
		l1.setFont(font1);
		l1.setHorizontalAlignment(SwingConstants.CENTER);
		l2 = new JLabel("Program powstał w 2017r");
		l2.setFont(font2);
		l2.setHorizontalAlignment(SwingConstants.CENTER);
		l3 = new JLabel("Łukasz Maciejczyk");
		l3.setFont(font3);
		l3.setHorizontalAlignment(SwingConstants.CENTER);
		l4 = new JLabel("Politechnika Koszalinska - WEiI");
		l4.setFont(font3);
		l4.setHorizontalAlignment(SwingConstants.CENTER);
		l5 = new JLabel("e-mail: lukasz482@gmail.pl");
		l5.setFont(font4);
		lBorder = new JLabel(""); 
		jBOk = new JButton("Ok");
